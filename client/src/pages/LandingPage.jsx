...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-dark-100 text-dark-900 overflow-x-hidden">
      {/* Navbar */}
      <nav className="sticky top-0 z-30 border-b border-dark-200 bg-white/80 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-lg text-dark-900">ResumeAI</span>
          </div>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 bg-mesh overflow-hidden">
        ...
        <div className="absolute bottom-10 right-1/4 w-64 h-64 bg-primary-500/5 rounded-full blur-3xl" />
        ...
        >
          <motion.div variants={fadeUp} className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-primary-500/10 border border-primary-500/20 text-sm text-primary-600">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Powered by Google Gemini AI</span>
          </motion.div>

          <motion.h1 variants={fadeUp} className="text-5xl sm:text-6xl lg:text-7xl font-display font-bold leading-tight mb-6 text-dark-900">
            Build{' '}
          ...
          <motion.p variants={fadeUp} className="text-xl text-dark-600 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-8">
            {['No credit card required', 'Free forever', '5 templates'].map(item => (
              <div key={item} className="flex items-center gap-1.5 text-sm text-dark-600">
      ...
      {/* Stats */}
      <section className="py-12 border-y border-dark-200 bg-white/50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              ...
              >
                ...
                <h3 className="font-display font-semibold text-dark-900 text-lg mb-2">{feature.title}</h3>
      ...
      {/* Templates showcase */}
      <section className="py-24 px-4 bg-dark-200/40">
        <div className="max-w-6xl mx-auto">
          <motion.div className="text-center mb-16"
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-4xl font-display font-bold text-dark-900 mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {templates.map((tpl, i) => (
              ...
              >
                <div className={`h-40 rounded-2xl bg-gradient-to-br ${tpl.color} relative overflow-hidden border border-dark-200 group-hover:border-primary-500/50 transition-all duration-300 group-hover:shadow-glow mb-3`}>
                  {/* Mini resume mockup */}
                  <div className="absolute inset-3 bg-white/15 rounded-lg backdrop-blur-xs flex flex-col gap-1.5 p-2">
                    <div className="h-2.5 bg-white/75 rounded w-20" />
                ...
                <p className="text-sm font-semibold text-dark-900 text-center">{tpl.name}</p>
                <p className="text-xs text-dark-600 text-center">{tpl.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className="text-[10px] font-mono text-primary-600 uppercase tracking-widest mb-2">{item.step}</div>
                <h3 className="text-lg font-display font-bold text-dark-900 mb-2">{item.title}</h3>
      ...
      <section className="py-24 px-4">
        ...
        >
          <div className="card border border-primary-500/10 bg-gradient-card relative overflow-hidden">
            ...
            <div className="relative z-10 py-8">
              ...
              <p className="text-dark-600 mb-8 max-w-lg mx-auto">
      ...
      {/* Footer */}
      <footer className="border-t border-dark-200 py-8 px-4 bg-white">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg bg-gradient-primary flex items-center justify-center">
              <Sparkles className="w-3.5 h-3.5 text-white" />
            </div>
            <span className="font-display font-bold text-dark-900 text-sm">ResumeAI</span>
          </div>
